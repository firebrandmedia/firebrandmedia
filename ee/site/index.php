...
<div id="homepage_content" class="group">
	<div id="homepage_featured_project" class="group">
		<i class="icon-left-open"></i><h2>Featured Project: {title}</h2>
		...
		<div class="homepage_recent">
			<h3>Recently Added Projects & Posts</h3>
			<ul>
			...
			<li><i class="{categories limit="1" show="not 18"}{category_url_title}{/categories}"></i><a href="{title_permalink='stuffwevedone/project'}" title="{title}">{title}</a></li>
			{/exp:channel:entries}
			</ul>
		</div>
