...
{exp:channel:entries channel="portfolio" limit="11" disable="categories|category_fields|member_data|pagination"}
<div class="{switch='one|two_a|two_b|three_a|three_b|three_c|three_d|three_e|three_f'}">{portfolio_images limit="1"}<a href='{title_permalink='stuffwevedone/project'}'>
{exp:imgsizer:size src="{portfolio_sample_image}" height="495" width="495"}
<img src="{sized}" height="{height}" width="{width}" alt="{title}" />
{/exp:imgsizer:size}</a>{/portfolio_images}</div>
{/exp:channel:entries}
