...
<ul>
{exp:channel:entries  channel="portfolio"  orderby="date" dynamic="off" limit="5" disable="member_data|pagination|category_fields"}
...
{if no_results}
<ul>
<li><li><i class="icon-calendar"></i>Sorry, I don't have any planned events at this time.</li>
</ul>
{/if}
{/exp:channel:entries}
</div>-->
